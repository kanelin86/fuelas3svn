package 
{
	...
	*/
	...
	public class StringUtils {
		...
		public static function getBytes( p_string:String ):ByteArray
		{
			var ba:ByteArray = new ByteArray();
			ba.writeUTFBytes( p_string );
			ba.position = 0;
			return( ba );		
		}
		
		public static function regionMatches( p_string:String, ignoreCase:Boolean, toffset:int, other:String, ooffset:int, len:int ):Boolean
		{
			var str1:String = p_string.substr( toffset, len );
			var str2:String = other.substr( ooffset, len );
		...
		public static function deleteChars( p_string:String, start:int, end:int ):String
		{
...
/**
		...
		*/
		...
		public static function startsWith( p_string:String, p_begin:String):Boolean {
			return( beginsWith( p_string, p_begin ) );	
		}
